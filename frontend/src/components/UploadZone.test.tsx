...
describe('UploadZone', () => {
  it('forwards selected PDF files', async () => {
    ...
    render(
      <UploadZone dragActive={false} error={null} onDrag={vi.fn()} onDrop={vi.fn()} onFileSelected={onFileSelected} />,
    );
  ...
  it('clicks the hidden file input when the drop zone is activated', () => {
    ...
    render(<UploadZone dragActive={false} error={null} onDrag={vi.fn()} onDrop={vi.fn()} onFileSelected={vi.fn()} />);
