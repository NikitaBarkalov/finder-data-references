      ...
      {rateLimitDelay !== null && rateLimitDelay > 0 && pipelineStatus === 'loading' && (
        ...
        >
          ...
          <span style={{ lineHeight: 1.4 }}>
            ...
            <br />
            Processing is paused and will automatically resume in <strong>{Math.ceil(rateLimitDelay)}</strong>{' '}
            seconds...
          </span>
        </div>
      )}
            ...
            <div key={step.id} className={`step-item ${stepStatusClass}`}>
              ...
              <div className="step-content-col">
                <div className={`step-label ${stepStatusClass}`}>
                  ...
                  {isSkipped && (
                    <span
                      style={{ marginLeft: '8px', fontSize: '0.8em', color: 'var(--accent-color)', fontWeight: '600' }}
                    >
                      (Skipped)
                    </span>
                  )}
                ...
                {isActive && llmProgress && (
                  <div
                    className="step-detail active"
                    style={{
                      marginTop: stepDetails[index] ? '0.4rem' : '0',
                      fontWeight: 600,
